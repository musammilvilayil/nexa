...
class LiveExecutionController:
    ...
    Every new entry still requires broker health, live-eligible strategy state,
    position sizing, and RiskEngine approval. A kill switch blocks new exposure
    but cannot trap an existing position by blocking a pure exit.
    """
